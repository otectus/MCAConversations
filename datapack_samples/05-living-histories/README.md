...
So copy this whole folder into **both**:

```
<instance>/saves/<world>/datapacks/05-living-histories/
<instance>/resourcepacks/05-living-histories/
```
...
`pack_format` 15 — that is 1.20.1 for both data packs and resource packs, which is what lets the
same folder be used as both halves.
