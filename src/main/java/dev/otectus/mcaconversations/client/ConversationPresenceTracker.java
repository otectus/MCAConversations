 ...
 * ping: a cheap packet on a fixed cadence, carrying nothing the server has to trust.
 *
...
public final class ConversationPresenceTracker {
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        ticksSincePing = 0;
        try {
            ConversationsNetwork.CHANNEL.sendToServer(new ConversationPresenceC2S(ref));
        } catch (Throwable t) {
