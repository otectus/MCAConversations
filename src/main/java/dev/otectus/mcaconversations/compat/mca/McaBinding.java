...
public final class McaBinding {
    ...
    //
    // Verified present and signature-identical in 7.6.20+1.20.1 and 7.7.0-beta.2+1.20.1 (both
    // forge.net.mca) and 7.7.1-alpha.2+1.20.1 (forge.net.conczin.mca); McaBindingProbeTest replays all
    // three on every build. Three entries are ambiguous by name alone and are called out below.
    //
    ...
    private static final String C_NETWORK = "cobalt.network.NetworkHandler";
