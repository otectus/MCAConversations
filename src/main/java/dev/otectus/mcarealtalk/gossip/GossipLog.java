 ...
 * deterministic newest-first query shared by the {@code realtalk_gossip} condition and the
 * {@code realtalk_gossip_say} action (they must agree on which event is "next").
 */
