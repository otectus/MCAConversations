...
> **Status.** This is the *pre-work* snapshot and is deliberately preserved as one. Phases 0, 1 and
> 2 have since landed: the gaps §4 records are closed (real personality baselines, real stance fit,
> real arc stage), and the reward-on-ask count in §2 has fallen from 131 to 124 as the Day and Fears
> pilots converted. `ConversationGraphLintTest` carries the live count as a migration ledger. §7
> remains true and unchanged: **no live production verification has been performed.**
